...
// Fungsi untuk print struk sebagai gambar PNG (untuk print langsung)
export const printReceipt = async (item, settings) => {
    const fmt = (n) => new Intl.NumberFormat('id-ID', {
        style: 'currency',
        currency: 'IDR',
        minimumFractionDigits: 0,
    ...
    // Buat HTML untuk struk (sama seperti cetakKwitansi)
    const receiptHTML = `
        <div id="thermal-receipt" style="
            width: 302px;
            padding: 10px;
    ...
    try {
        ...
        // Buka window baru dengan gambar untuk print
        ...
        if (printWindow) {
            ...
            alert('Popup blocker menghalangi print. Mohon izinkan popup untuk print.');
        }

    } catch (error) {
        console.error('Error generating print:', error);
        alert('Gagal membuat print struk. Silakan coba lagi.');
        // Cleanup on error

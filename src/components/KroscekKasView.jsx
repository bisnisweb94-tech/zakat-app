...
function KroscekKasView({ data, user, setData }) {
    ...
    return (
        <div className="space-y-4 sm:space-y-6 max-w-5xl mx-auto pb-24 px-4 sm:px-0 text-left">
            <div className="flex flex-col sm:flex-row justify-between items-center gap-3">
                ...
                {activeTab === 'tasks' && (
                    <button
                        ...
                        className="w-full sm:w-auto flex items-center justify-center gap-2 px-6 py-2.5 bg-blue-500/20 text-blue-400 border border-blue-500/30 rounded-xl font-bold text-xs hover:bg-blue-500/30 transition"
                    >
            ...
            {activeTab === 'input' ? (
                <>
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 bg-[var(--bg-surface)] p-4 rounded-2xl border border-[var(--border-surface)]">
                        ...
                        <button onClick={handleSave} disabled={saving} className="w-full sm:w-auto px-6 py-2.5 bg-emerald-500/20 text-emerald-400 border border-emerald-500/30 rounded-xl font-bold text-sm disabled:opacity-50">{saving ? 'Menyimpan...' : 'Simpan Data'}</button>
                    </div>
